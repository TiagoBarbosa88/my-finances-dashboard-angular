import { Ativo, Investimento, TargetMeta, TipoAtivo } from '@app/shared/models/investimentos.model';
...
export const INITIAL_ATIVOS: Ativo[] = [
  // ── Ações ──
  { id: 1, ticker: 'ITUB4',  tipo: 'Ações', setor: 'Financeiro',   qtd: 15, precoMedio: 41.00,  precoAtual: 39.87, rentabilidadePct: 0.83,  score: 8 },
  { id: 2, ticker: 'TAEE11', tipo: 'Ações', setor: 'Energia',      qtd: 11, precoMedio: 41.48,  precoAtual: 39.30, rentabilidadePct: -3.87, score: 7 },
  { id: 3, ticker: 'AESB3',  tipo: 'Ações', setor: 'Energia',      qtd: 33, precoMedio: 12.15,  precoAtual: 8.12,  rentabilidadePct: -31.60, score: 4 },
  { id: 4, ticker: 'SAPR4',  tipo: 'Ações', setor: 'Saneamento',   qtd: 23, precoMedio: 8.61,   precoAtual: 7.27,  rentabilidadePct: 73.45, score: 6 },
  { id: 5, ticker: 'BBAS3',  tipo: 'Ações', setor: 'Financeiro',   qtd: 6,  precoMedio: 23.37,  precoAtual: 19.42, rentabilidadePct: 75.93, score: 8 },
  { id: 6, ticker: 'MGLU3',  tipo: 'Ações', setor: 'Varejo',       qtd: 1,  precoMedio: 65.53,  precoAtual: 4.62,  rentabilidadePct: -77.29, score: 3 },

  // ── FIIs ──
  { id: 7, ticker: 'PCIP11', tipo: 'FIIs',  setor: 'Papel',        qtd: 1,  precoMedio: 118.29, precoAtual: 80.26, rentabilidadePct: -9.35, score: 7 },

  // ── ETFs ──
  { id: 8, ticker: 'SPXB11', tipo: 'ETFs',  setor: 'S&P 500',      qtd: 21, precoMedio: 15.79,  precoAtual: 17.05, rentabilidadePct: 113.53, score: 9 },
];
